...
public class OutfitController {
    ...
    public ResponseEntity<List<OutfitResponse>> getMyOutfits(
            @org.springframework.security.core.annotation.AuthenticationPrincipal String email) {
        return ResponseEntity.ok(outfitService.getMyOutfits(email));
    }
